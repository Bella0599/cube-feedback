...
DIAGNOSIS_DB = {
    ...
    "Grammar (문법)": {"be동사와 일반동사 쓰임 혼동하는 모습이 보입니다.": "두 동사의 핵심 차이점을 직관적으로 인지시키고, 문장 구조 드릴 학습을 강화하겠습니다.","명사의 단수, 복수 혼동하는 모습이 보입니다.": "수업시간에 더 많은 연습을 통해 자연스럽게 이해하고, 시험에 연결 될 수 있도록 강화하겠습니다."},
