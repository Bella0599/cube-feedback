...
st.markdown("구글 시트 연동형 교재 DB 및 프리미엄 14대 성향 밀착 피드백 엔진")
st.divider()
...
# 💡 [14대 세부 성향별 데이터베이스 구축 - v22.0 업데이트]
TRAITS_DB = {
    "📚 집중형": [
        "수업 중 교사의 설명이 시작되면 자연스럽게 시선과 집중이 수업으로 향하는 모습이 인상적이었습니다. 배운 내용을 놓치지 않으려는 태도가 꾸준히 보이며, 학습에 대한 성실함이 큰 강점으로 느껴집니다.",
        "활동이 진행되는 동안 주변 분위기에 쉽게 흔들리지 않고 자신의 학습에 집중하는 모습을 보여주었습니다. 차분하게 내용을 이해하고 정리해 나가는 모습에서 학습에 대한 책임감이 느껴졌습니다.",
        "새로운 내용을 배울 때도 교사의 설명을 끝까지 들은 후 문제를 해결하려는 습관이 잘 형성되어 있습니다. 성급하게 답을 찾기보다 이해하려고 노력하는 모습이 인상적입니다.",
        "수업 시간에 배운 내용을 공책이나 교재에 꼼꼼하게 표시하며 따라오는 모습이 자주 보였습니다. 작은 부분도 놓치지 않으려는 태도가 꾸준한 성장으로 이어지고 있습니다.",
        "학습 활동 중에는 자신의 차례가 아니더라도 끝까지 집중하며 친구들의 발표를 경청하는 모습을 보여주었습니다. 이러한 집중력은 앞으로 더욱 큰 학습 자산이 될 것으로 기대됩니다."
    ],
    "🎤 발표형": [
        "질문을 받았을 때 망설이기보다 먼저 답해 보려는 적극적인 모습이 인상적이었습니다. 영어로 표현하는 과정 자체를 즐기는 모습이 자주 보입니다.",
        "새로운 표현을 배우면 실제 말하기 활동에서 바로 활용해 보려는 적극성이 돋보였습니다. 영어를 사용하는 데 대한 자신감이 점점 자라고 있습니다.",
        "친구들 앞에서 발표할 때 자신의 생각을 또렷하게 전달하려는 모습이 인상적이었습니다. 표현력뿐 아니라 자신감도 함께 성장하고 있습니다.",
        "수업 중 질문에 가장 먼저 손을 들거나 의견을 나누는 모습이 자주 보였습니다. 영어를 배움의 대상이 아닌 소통의 도구로 활용하려는 태도가 돋보입니다.",
        "말하기 활동에서는 실수를 크게 의식하지 않고 자신 있게 표현하려고 노력하는 모습이 인상적이었습니다. 적극적인 참여가 영어 실력 향상으로 자연스럽게 이어질 수 있도록 돋보입니다."
    ],
    "🌟 리더형": [
        "모둠 활동이 시작되면 친구들이 활동에 잘 참여할 수 있도록 자연스럽게 분위기를 이끌어 주는 모습을 보여주었습니다.",
        "친구들이 어려워하는 부분이 있을 때 먼저 도와주거나 설명해 주려는 모습이 자주 보였습니다. 배려와 책임감이 함께 돋보이는 학생입니다.",
        "활동 중 자신의 역할을 충실히 수행할 뿐만 아니라 주변 친구들의 참여도 함께 이끌어 주는 모습이 인상적이었습니다.",
        "수업 분위기가 다소 산만해질 때도 자신의 역할에 집중하며 긍정적인 에너지를 만들어 주고 있습니다.",
        "친구들과 협력하는 과정에서 자신의 의견을 잘 전달하면서도 상대방의 의견을 존중하는 성숙한 모습을 보여주었습니다."
    ],
    "💪 노력형": [
        "쉽지 않은 문제를 만나도 바로 포기하기보다 한 번 더 생각해 보려는 모습이 자주 보였습니다. 꾸준히 노력하는 태도가 매우 기특합니다.",
        "정답을 맞히는 것보다 배우는 과정에 집중하려는 모습이 인상적이었습니다. 작은 성장도 소중하게 만들어 가고 있습니다.",
        "처음에는 어려워하던 내용도 반복 학습을 통해 차근차근 익혀 나가는 모습을 보여주었습니다.",
        "수업 중 실수가 있어도 다시 시도하며 배우려는 태도가 돋보였습니다. 포기하지 않는 힘이 큰 장점입니다.",
        "매 수업 성실하게 참여하며 자신의 부족한 부분을 채워 가기 위해 노력하는 모습이 인상적이었습니다."
    ],
    "📈 성장형": [
        "처음에는 조심스럽게 참여하던 활동도 이제는 훨씬 적극적으로 참여하는 모습을 보여주고 있습니다. 눈에 띄는 성장이 느껴집니다.",
        "배운 표현을 이해하는 속도와 활용하는 능력이 꾸준히 향상되고 있습니다. 학습에 대한 자신감도 함께 높아지고 있습니다.",
        "이전에는 어려워하던 문제 유형도 스스로 해결하는 경우가 늘어나고 있습니다. 성장의 폭이 크게 느껴집니다.",
        "수업 참여도와 학습 태도 모두 긍정적으로 변화하고 있으며, 영어를 대하는 자세가 한층 성숙해졌습니다.",
        "한 달 전과 비교했을 때 영어에 대한 이해도와 자신감이 눈에 띄게 향상된 모습이 인상적이었습니다."
    ],
    "😊 자신감형": [
        "최근에는 영어로 말하는 것을 주저하기보다 먼저 시도해 보려는 모습이 자주 보이고 있습니다.",
        "발표나 말하기 활동에서 자신 있게 참여하며 영어 사용에 대한 두려움이 많이 줄어든 모습입니다.",
        "실수를 크게 의식하지 않고 다양한 표현을 사용하려는 모습이 인상적이었습니다.",
        "수업 중 자신의 생각을 자연스럽게 이야기하며 영어에 대한 자신감을 키워가고 있습니다.",
        "처음보다 훨씬 밝고 적극적으로 수업에 참여하며 영어 사용을 즐기는 모습이 돋보입니다."
    ],
    "개별 맞춤 복습이 조금 더 필요한 음가/알파벳 (없으면 비워두세요)": [
        "수업 시간에는 다소 조용한 편이지만, 교사의 질문에 끝까지 생각하며 답하려는 모습이 인상적이었습니다. 자신의 속도로 차근차근 참여하며 성장하고 있습니다.",
        "발표나 말하기 활동에서는 처음에 망설이는 모습도 있었지만, 최근에는 조금씩 용기를 내어 참여하는 모습이 보이고 있습니다. 작은 변화가 매우 기특하게 느껴집니다.",
        "눈에 띄게 표현하기보다는 차분히 수업을 따라오며 배운 내용을 자신의 것으로 만들어 가고 있습니다. 꾸준한 성장이 기대되는 학생입니다.",
        "교사의 설명을 집중해서 듣고 이해한 뒤 조심스럽게 표현하는 모습이 자주 보였습니다. 신중하게 생각하는 태도가 큰 강점입니다.",
        "활동 중에는 조용히 참여하지만 맡은 역할은 끝까지 책임감 있게 수행하는 모습을 보여주었습니다. 성실함이 돋보이는 학생입니다."
    ],
    "⚡ 에너지형": [
        "수업에 들어오는 순간부터 밝은 에너지로 교실 분위기를 활기차게 만들어 주고 있습니다. 적극적인 참여가 큰 장점입니다.",
        "활동 시간마다 누구보다 먼저 참여하려는 모습을 보여주며 수업에 즐거움을 더해주고 있습니다.",
        "새로운 게임이나 활동이 시작되면 높은 관심을 보이며 적극적으로 참여합니다. 긍정적인 에너지가 친구들에게도 좋은 영향을 주고 있습니다.",
        "수업 중 활발하게 의견을 나누고 적극적으로 반응하는 모습이 인상적이었습니다. 배움에 대한 호기심이 풍부한 학생입니다.",
        "밝고 적극적인 태도로 수업 분위기를 즐겁게 만들어 주며 영어 활동에도 자신 있게 참여하고 있습니다."
    ],
    "🧐 꼼꼼형": [
        "문제를 해결할 때 답을 제출하기 전에 한 번 더 확인하는 습관이 잘 형성되어 있습니다. 꼼꼼한 학습 태도가 돋보입니다.",
        "수업 중 중요한 내용을 빠뜨리지 않기 위해 메모하거나 표시하는 모습이 자주 보였습니다. 세심한 관찰력이 강점입니다.",
        "과제를 수행할 때 작은 부분까지 신경 쓰며 정확하게 마무리하려는 모습이 인상적이었습니다.",
        "배운 내용을 정리하고 복습하는 과정에서도 꼼꼼함이 돋보였습니다. 학습에 대한 책임감이 느껴집니다.",
        "어휘 철자나 문장 구성의 작은 부분도 놓치지 않으려는 노력이 보였습니다. 차분하고 성실한 학습 태도가 강점입니다."
    ],
    "🎯 승부욕형": [
        "학습 활동에 참여할 때 항상 최선을 다하며 스스로 만족할 수 있는 결과를 만들기 위해 노력하는 모습이 인상적이었습니다.",
        "퀴즈나 게임 활동에서 높은 집중력을 보이며 끝까지 최선을 다하는 태도가 돋보였습니다.",
        "목표를 정하면 쉽게 포기하지 않고 끝까지 도전하는 모습이 자주 보였습니다. 학습에 대한 의지가 강한 학생입니다.",
        "자신의 실수를 그냥 넘기지 않고 다시 확인하며 더 나은 결과를 만들기 위해 노력하는 모습이 인상적이었습니다.",
        "배운 내용을 정확하게 이해하고 적용하기 위해 꾸준히 노력하며 성장하려는 의지가 돋보였습니다."
    ],
    "💬 친화형": [
        "친구들과 자연스럽게 어울리며 수업 활동에도 적극적으로 참여하는 모습이 인상적이었습니다.",
        "모둠 활동에서 친구들과 원활하게 소통하며 긍정적인 분위기를 만들어 주고 있습니다.",
        "새로운 친구와도 자연스럽게 대화하며 협력하는 모습이 자주 보였습니다. 사회성이 뛰어난 학생입니다.",
        "수업 중 친구들의 의견을 잘 들어주고 함께 참여하려는 태도가 돋보였습니다.",
        "친구들과의 관계가 원만하며 교실 분위기를 더욱 편안하게 만들어 주는 따뜻한 장점을 가지고 있습니다."
    ],
    "🌈 감수성형": [
        "수업 중 이야기나 활동의 의미를 깊이 있게 생각하며 자신만의 시각으로 표현하는 모습이 인상적이었습니다.",
        "친구들의 감정이나 상황을 잘 이해하고 공감하는 따뜻한 모습을 자주 보여주었습니다.",
        "표현 활동에서 자신의 생각과 느낌을 섬세하게 담아내는 모습이 돋보였습니다.",
        "작은 변화도 잘 알아차리고 주변을 세심하게 살피는 모습이 인상적이었습니다.",
        "풍부한 감성과 배려심을 바탕으로 수업 활동에 진정성 있게 참여하고 있습니다."
    ],
    "🚶 꾸준형": [
        "눈에 띄는 변화보다도 자신의 속도로 차근차근 성장해 나가는 모습이 인상적이었습니다.",
        "매 수업 성실하게 참여하며 학습 습관을 꾸준히 유지하고 있습니다. 꾸준함이 큰 강점입니다.",
        "특별한 기복 없이 안정적으로 학습을 이어가며 차곡차곡 실력을 쌓아가고 있습니다.",
        "배운 내용을 반복하며 자신의 것으로 만들어 가는 과정이 매우 성실하게 이루어지고 있습니다.",
        "한 번에 큰 변화를 만들기보다 꾸준한 노력으로 성장하는 모습이 매우 인상적이었습니다."
    ],
    "☀️ 긍정형": [
        "새로운 활동이나 과제를 항상 긍정적인 태도로 받아들이며 즐겁게 참여하는 모습이 인상적이었습니다.",
        "어려운 문제가 나와도 '한번 해볼게요!'라는 마음으로 도전하는 모습이 매우 기특했습니다.",
        "수업 중 밝은 표정과 적극적인 반응으로 교실 분위기를 더욱 즐겁게 만들어 주고 있습니다.",
        "실수가 있더라도 금세 다시 도전하며 긍정적으로 배우려는 태도가 돋보였습니다.",
        "학습 과정 자체를 즐기며 새로운 경험을 열린 마음으로 받아들이는 모습이 매우 인상적이었습니다."
    ]
}
...
CLOSING_MENT_DB = {
    ...
    "🛡️ [안심 전달형] 정성과 책임을 강조할 때": "매시간 아이들의 눈넣이에서 가장 필요한 것이 무엇인지 고민하며 수업하고 있습니다. 아이가 영어 때문에 힘들지 않게, 오히려 영어로 자신감을 얻을 수 있도록 세심하게 지도하겠습니다. 시험 결과에 대해 궁금하신 점은 언제든 편하게 연락해 주세요. 감사합니다."
}
...
# 원장님 피드백 반영: 14개 성향을 깔끔하고 풍성하게 연출하는 다중 확장 레이아웃
with st.expander("✨ 아이의 14대 맞춤형 상세 성향 코멘트 선택 (복수 선택 가능)"):
    st.caption("필요한 만큼 여러 성향 및 버전을 조합할 수 있습니다. 성적표에는 가독성 높게 정렬되어 들어갑니다.")
    for trait_type, versions in TRAITS_DB.items():
        selected_vers = st.multiselect(f"🔹 {trait_type}", versions, key=f"trait_{trait_type}")
        selected_traits.extend(selected_vers)
    ...
    if not selected_student:
        ...
        if sub_book and sub_book != "선택안함":
            ...
            if s_score_num >= 90:
                ...
                sub_narrative = f"\n\n또한, {sub_book}를 활용한 심화 및 문장 확장 학습 과정을 성실하게 수행해 나가고 있습니다. 특정 취약 패턴에서 미세한 실수가 발생하지 않도록 오답 분석을 통해 단단하게 교정해 가겠습니다."
            else:
                sub_narrative = f"\n\n또한, {sub_book}새로운 문법 개념과 문장 구조를 배우는 과정에서 조금 더 반복적인 연습이 필요한 모습이 관찰되었습니다. 아이의 학습 속도에 맞춰 차근차근 개념을 정리하고, 학습 자신감을 키워 나갈 수 있도록 세심하게 지도하겠습니다."
        ...
        if not care_plan_text: care_plan_text = f"· 현재 {selected_en_name}는 모든 학습 영역을 균형 있게 소화하며 안정적인 학습 흐름을 유지하고 있습니다. 눈에 띄는 강점만큼이나 꾸준함และ 성실함이 돋보이며, 차근차근 실력을 쌓아가고 있는 모습이 인상적입니다.\n"
